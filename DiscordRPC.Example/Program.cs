...
class Program
{
    ...
    /// </summary>
    private static StringBuilder word = new();
    ...
    static void BasicExample()
    {
        ...
        client.SetPresence(new RichPresence
        {
            ...
            Buttons =
            [
                new() { Label = "Fish", Url = "https://lachee.dev/" }
            ]
        });
    ...
    {
        var readyCompletionSource = new TaskCompletionSource<User>();
    ...
    private static void OnJoinRequested(object sender, JoinRequestMessage args)
    {
        ...
        var accept = Console.ReadKey().Key == ConsoleKey.Y;
        Console.WriteLine();

        //Tell the client if we accept or not.
        var senderClient = (DiscordRpcClient)sender;
    ...
    static void ExecuteCommand(string word)
    {
        ...
        var whitespaceIndex = word.IndexOf(' ');
